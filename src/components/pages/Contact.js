        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-sm-12 col-sm-8 col-md-6">
                    <form method="post" action="mailto:william.white86@gmail.com" enctype="text/plain">
                        ...
                        <small id="emailHelp" className="form-text text-light">I'll never share your email with anyone
                            else.</small>
